...
Saystack adds many simple convenience methods to Swift API's. Multiple frameworks are extended, including UIKit and Foundation. Both macOS and iOS are supported, but the framework is mainly targeting iOS, as macOS does not support UIKit.
